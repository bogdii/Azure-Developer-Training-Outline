...
namespace P01PlayersMVCWebApp.Controllers
{
    public class VolleyballPlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Position,Numer")] VolleyballPlayer volleyballPlayer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Position,Numer")] VolleyballPlayer volleyballPlayer)
        {
